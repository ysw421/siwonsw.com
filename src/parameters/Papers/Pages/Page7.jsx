...
export default function Page7(props) {
  return (
    <>
      ...
      원을 그려 이해하였죠. 비단 차원에 대하여 일반화한 선형 대수학에서는 2차에 대한 직관적 이해를 통해 다차원을
      사고적으로 이해하여야 합니다. 다차원에 대하여 직관적 이해가 불가능하다는 점은 선형 대수학이 어렵게 느껴지는
      이유이며, 또한 매력이라 생각합니다. 해당 카테고리에선 직관적 이해를 돕기 위한 시각화된 그래프 및 상호작용이 가능한
      오브젝트를 사용 할 예정입니다. 이를 통하여 보다 직관적 이해를 늘리고 선형 대수학에 대한 흥미를 높이는 것이
      목표입니다.
      <br />
      <br />
      <br />
