      ...
      <Dialog as='div' className='relative z-10' onClose={onCloseModal}>
        ...
        <div className='fixed inset-0 z-10 overflow-y-auto'>
          <div className='flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'>
            ...
            >
              <Dialog.Panel className='dark:bg-gray-lightbg relative transform overflow-hidden rounded-xl bg-white px-4 pt-2.5 pb-4 text-left shadow-xl transition-all [min-height:18rem] sm:my-8 sm:w-full sm:max-w-xs sm:p-4'>
