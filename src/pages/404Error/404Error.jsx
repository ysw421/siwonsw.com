  ...
  return (
    <div className={styles.container}>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className={styles.container}>
        <div>
          {/* <img alt="404" src={process.env.PUBLIC_URL + '/img/404/404img.svg'} className={styles.image} /> */}
          {/* <svg
          ...
          >
            <g>
              <circle cx="559.4329" cy="333.06116" r="40.02979" />
              <path
              ...
              <path
                ...
                transform="translate(-108.75634 -68.49293)"
              />
              <circle cx="753.92061" cy="258.80372" r="24.56103" />
              <path
        ...
        <p className={styles.title}>404 Error</p>
        <p className={styles.subtitle}>Page not found</p>
      </motion.div>
      <div className={styles.goHomeContainer}>
        <span>여기를 클릭하여 홈으로</span>
        <svg width="40" height="auto" viewBox="-2 -2 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M0.5 11H14C18 11 19 7.66667 19 6V1M15 4L18 1C18.8 0.200002 19.6667 0.666669 20 1L23 4"
            stroke={props.isDarkMode ? '#f8f8f8' : '#201c1c'}
            stroke-width="1.2"
